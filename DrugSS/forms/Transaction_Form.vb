Public Class Transaction_Form
    ...
    Private Sub btnSup_supSearch_Click(sender As Object, e As EventArgs) Handles btnSup_supSearch.Click
        Supplier_Form.Show()
        txt_suplierId.Clear()
        Supplier_Form.btnadd.Visible = True
    End Sub

    Private Sub btnSup_itemSearch_Click(sender As Object, e As EventArgs) Handles btnSup_itemSearch.Click
        StockMaster_Form.Show()
        StockMaster_Form.btnadd.Visible = True
    End Sub

    Private Sub btnSup_addtocart_Click(sender As Object, e As EventArgs) Handles btnSup_addtocart.Click
        Try
    ...
    Private Sub txtSup_itemid_TextChanged(sender As Object, e As EventArgs) Handles txtSup_itemid.TextChanged
        Try
    ...
    Private Sub txtSup_qty_TextChanged(sender As Object, e As EventArgs) Handles txtSup_qty.TextChanged
        Try
    ...
    Private Sub btnSup_save_Click(sender As Object, e As EventArgs) Handles btnSup_save.Click
        For Each r As DataGridViewRow In dtgSup_cartlist.Rows
            sql = "INSERT INTO `tblstock_in_out` ( `TRANSACTIONNUMBER`, `ITEMID`, `TRANSACTIONDATE`, `QTY`, `TOTALPRICE`, `SUPLIERID`,REMARKS)" &
        ...
        Next
        '-------------------------------------------------insert 
        sql = "INSERT INTO  `tbltransaction` (`TRANSACTIONNUMBER`,  `TRANSACTIONDATE`,  `TYPE`, `SUPLIERID`)" &
    ...
    Private Sub btnSup_edit_Click(sender As Object, e As EventArgs) Handles btnSup_edit.Click
        Try
    ...
    Private Sub btnStaockin_list_Click(sender As Object, e As EventArgs) Handles btnStaockin_list.Click
        ViewStockIn_Form.Show()
        ViewStockIn_Form.Focus()
    End Sub
    ...
    Private Sub btncus_search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncus_search.Click
        ViewCustomer_Form.Show()
        ' frmview_customer.btnadd.Visible = True
    End Sub

    Private Sub btnCus_add_Click(sender As Object, e As EventArgs) Handles btnCus_add.Click
        Try
    ...
    Private Sub btnCus_Remove_Click(sender As Object, e As EventArgs) Handles btnCus_Remove.Click
        Try
    ...
    Private Sub btnCus_clear_Click(sender As Object, e As EventArgs) Handles btnCus_clear.Click
        dtCus_addedlist.Rows.Clear()
    End Sub

    Private Sub btnCus_save_Click(sender As Object, e As EventArgs) Handles btnCus_save.Click
    ...
    Private Sub btnreturnadd_Click(sender As Object, e As EventArgs) Handles btnreturnadd.Click
        Try
    ...
    Private Sub btnreturn_remove_Click(sender As Object, e As EventArgs) Handles btnreturn_remove.Click
        Try
    ...
    Private Sub btnreturn_clear_Click(sender As Object, e As EventArgs) Handles btnreturn_clear.Click
        dtgreturn_cart.Columns.Clear()
    End Sub

    Private Sub btnreturn_save_Click(sender As Object, e As EventArgs) Handles btnreturn_save.Click
        If txttransactionid.Text = "" Then
            MsgBox("There are empty fields left that must be fill up!", MsgBoxStyle.Exclamation)
            Return
        End If
    ...
    Private Sub btnreturn_Search_Click(sender As Object, e As EventArgs) Handles btnreturn_Search.Click
        ViewTransaction_Form.Show()
        ViewTransaction_Form.Focus()
    End Sub

    Private Sub btnviewStockout_Click(sender As Object, e As EventArgs) Handles btnviewStockout.Click
        ViewStockOut_Form.Show()
        ViewStockOut_Form.Focus()
    End Sub

    Private Sub btnvewlreturn_Click(sender As Object, e As EventArgs) Handles btnvewlreturn.Click
        ViewReturn_Form.Show()
        ViewReturn_Form.Focus()
    End Sub
    ...
    Private Sub txt_suplierId_TextChanged(sender As Object, e As EventArgs) Handles txt_suplierId.TextChanged
        Try
            ...
            sql = "SELECT * FROM tblsuplier WHERE SUPLIERID ='" & txt_suplierId.Text & "'"
            reloadtxt(sql)
            If dt.Rows.Count > 0 Then
